  ...
  return (
    <div className="space-y-6">
      ...
      {assessment.conductedByName && (
        <div className="flex items-center gap-2 rounded-lg border border-inside-blue/20 bg-inside-blue/5 px-4 py-2.5 text-sm text-inside-blue">
          <svg className="h-4 w-4 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
          </svg>
          <span>Évaluation conduite par <strong>{assessment.conductedByName}</strong></span>
        </div>
      )}
